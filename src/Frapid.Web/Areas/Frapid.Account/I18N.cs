...
namespace Frapid.Account
{
	...
	public static class I18N
	{
		...
		///Current Password
		/// </summary>
		public static string CurrentPassword => I18NResource.GetString(ResourceDirectory, "CurrentPassword");

		/// <summary>
		///Edit User
		/// </summary>
		public static string EditUser => I18NResource.GetString(ResourceDirectory, "EditUser");
